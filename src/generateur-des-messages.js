...
// generateur de création d'un groupe privé
function generateClientCreatePrivateGroup(sender, groupName){
  return {
    from: sender,
    group: groupName,
    action: C_PR_GROUP,
...
// generateur de création d'un groupe public
function generateClientCreatePublicGroup(sender, groupName){
  return {
    from: sender,
    group: groupName,
    action: C_PU_GROUP,
